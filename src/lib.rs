...
mod tests {
    ...
    #[test]
    fn vector4d_dot() {
        let mut v1 = Vector4d::new(1, 2, 3, 4);
    ...
    #[test]
    fn vector4d_add() {
        let mut v1 = Vector4d::identity(1);
        let v = v1.add(v1.clone());
        assert_eq!(v.x, 2);
        assert_eq!(v.y, 2);
        assert_eq!(v.z, 2);
    ...
    #[test]
    fn vector4d_mul() {
        let mut v1 = Vector4d::identity(2);
        let v = v1.mul(v1.clone());
        assert_eq!(v.x, 4);
        assert_eq!(v.y, 4);
        assert_eq!(v.z, 4);
    ...
    #[test]
    fn matrix2d_product() {
        let mut m1 = Matrix2d::new(Vector2d::new(2, 1), Vector2d::new(3,4));
    ...
    fn matrix2d_add() {
        ...
        let m = m1.add(Matrix2d::identity(1));
        assert_eq!(m.items[0].x, 2);
    ...
    fn matrix2d_sub() {
        let m1 = Matrix2d::identity(1);
        let m = m1.sub(Matrix2d::identity(1));
    ...
    fn matrix2d_div() {
        ...
        let m = m1.div(Matrix2d::identity(2));
    ...
    fn matrix3d_add() {
        ...
        let m = m1.add(Matrix3d::identity(1));
        assert_eq!(m.items[0].x, 2);
        assert_eq!(m.items[0].y, 2);
    ...
    fn matrix3d_sub() {
        let m1 = Matrix3d::identity(1);
        let m = m1.sub(Matrix3d::identity(1));
        assert_eq!(m.items[0].x, 0);
        assert_eq!(m.items[0].y, 0);
    ...
    fn matrix3d_div() {
        ...
        let m = m1.div(Matrix3d::identity(2));
        assert_eq!(m.items[0].x, 5);
        assert_eq!(m.items[0].y, 5);
    ...
    fn matrix4d_add() {
        ...
        let m = m1.add(Matrix4d::identity(1));
        assert_eq!(m.items[0].x, 2);
        assert_eq!(m.items[0].y, 2);
        assert_eq!(m.items[0].z, 2);
    ...
    fn matrix4d_sub() {
        let m1 = Matrix4d::identity(1);
        let m = m1.sub(Matrix4d::identity(1));
        assert_eq!(m.items[0].x, 0);
        assert_eq!(m.items[0].y, 0);
        assert_eq!(m.items[0].z, 0);
    ...
    fn matrix4d_div() {
        ...
        let m = m1.div(Matrix4d::identity(2));
        assert_eq!(m.items[0].x, 5);
        assert_eq!(m.items[0].y, 5);
        assert_eq!(m.items[0].z, 5);
